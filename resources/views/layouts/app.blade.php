    ...
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-white md:w-64 dark:text-gray-200 dark:bg-gray-800" x-data="{ open: false }">
            ...
            <nav :class="{'block': open, 'hidden': !open}" class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto">
                ...
                <x-nav-link :href="route('dashboard.daily-updates.index')" :active="request()->routeIs('dashboard.daily-updates.index')"><i class="fa-solid fa-calendar-check mr-2"></i> Daily Updates</x-nav-link>
                @role('superadmin')
                <x-nav-link :href="route('dashboard.roles.index')" :active="request()->routeIs('dashboard.roles.index')"><i class="fa-solid fa-address-book mr-2"></i> Roles</x-nav-link>
                <x-nav-link :href="route('dashboard.permissions.index')" :active="request()->routeIs('dashboard.permissions.index')"><i class="fa-solid fa-file-prescription mr-2"></i> Permissions</x-nav-link>
                <x-nav-link :href="route('dashboard.users.index')" :active="request()->routeIs('dashboard.users.index')"><i class="fa-solid fa-user-pen mr-2"></i> Users</x-nav-link>
                @endrole
